package org.docryze.talk.payprovider.config;
...
public class DubboConfig {
    private static final String APPLICATION_NAME = "pay_provider";//应用名(需要更改)
    ...
    private static final String SCAN_PACKAGE = "org.docryze.talk.payprovider";//扫描包路径(需要更改)
